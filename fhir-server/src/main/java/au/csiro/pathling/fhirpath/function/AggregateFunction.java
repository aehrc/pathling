...
public abstract class AggregateFunction {
   ...
   * Column
   * @param expression the FHIRPath expression for the result
   * @return a new {@link FhirPath} representing the result of the same type of input
   */
  @Nonnull
  @SuppressWarnings("SameParameterValue")
  protected FhirPath applyAggregationFunction(@Nonnull final ParserContext context,
   ...
   * @param aggregationColumn a {@link Column} describing the aggregation
   * @param expression the FHIRPath expression for the result
   * @param contextPath the {@link FhirPath} of the result
   * @return a new {@link FhirPath} representing the result
   */
  @Nonnull
  protected FhirPath applyAggregation(@Nonnull final ParserContext context,
      @Nonnull final Dataset<Row> dataset, @Nonnull final Collection<FhirPath> inputs,
      @Nonnull final Column aggregationColumn, @Nonnull final String expression,
    ...
    return contextPath.copy(expression, result, newIdColumn, valueColumn,
        true, newThisColumn);
  }

 ...
 * similar to spark SQL {{Expression}} except that the the expressions need to be resolved before
 * they can be used which seem to be very hard to do outside of the Spark SQL plan analyzer.
 *

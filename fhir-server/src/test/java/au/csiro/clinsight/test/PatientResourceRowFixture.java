...
public class PatientResourceRowFixture {
	...
	public static final Row PATIENT_1_FEMALE = RowFactory.create("abc1", RowFactory.create("female", true));
	public static final Row PATIENT_2_FEMALE = RowFactory.create("abc2", RowFactory.create("female", false));
	public static final Row PATIENT_3_MALE = RowFactory.create("abc3", RowFactory.create("male", true));
	
	public final static List<Row> PATIENT_ALL_ROWS = Arrays.asList(PATIENT_1_FEMALE, PATIENT_2_FEMALE, PATIENT_3_MALE);

...
public class ParsedExpressionAssert {
	...
	public DatasetAssert selectResult() {
		return new DatasetAssert(parsedExpression.getDataset().select(parsedExpression.getIdColumn(), parsedExpression.getValueColumn())
	...
	public DatasetAssert aggByIdResult() {
		return new DatasetAssert(parsedExpression.getAggregationDataset()
				.groupBy(parsedExpression.getAggregationIdColumn()).agg(parsedExpression.getAggregationColumn()).orderBy(parsedExpression.getAggregationIdColumn()));
	}

...
public class InValueSetTest {
  ...
  public void simpleQuery() throws IOException, JSONException {
    ...
    String expectedSql =
        "SELECT CASE WHEN patientEncounterAsSubjectReasonCodingValueSetAggregated.code IS NULL THEN FALSE ELSE TRUE END AS `Diagnosis in value set?`, "
            ...
            + "ON patientEncounterAsSubjectReasonCodingExploded.patientEncounterAsSubjectReasonCoding.system = patientEncounterAsSubjectReasonCodingValueSet.system "
            + "AND patientEncounterAsSubjectReasonCodingExploded.patientEncounterAsSubjectReasonCoding.code = patientEncounterAsSubjectReasonCodingValueSet.code "
            + "GROUP BY 1"
  ...
  public void multipleSetsOfLateralViews() throws IOException {
    ...
    String expectedSql =
        "SELECT CASE WHEN diagnosticReportResultCodeCodingValueSetAggregated.code IS NULL THEN FALSE ELSE TRUE END AS `Globulin observation?`, "
            ...
            + "LEFT JOIN `valueSet_03775044c1767e1bcba62ef01cf1750d` diagnosticReportResultCodeCodingValueSet ON diagnosticReportResultCodeCodingExploded.diagnosticReportResultCodeCoding.system = diagnosticReportResultCodeCodingValueSet.system AND diagnosticReportResultCodeCodingExploded.diagnosticReportResultCodeCoding.code = diagnosticReportResultCodeCodingValueSet.code "
            + "GROUP BY 1"
  ...
  public void inValueSetMultipleAggregations() throws IOException {
    ...
    String expectedSql =
        "SELECT CASE WHEN patientMedicationRequestAsSubjectMedicationCodeableConceptCodingValueSetAggregated.code IS NULL THEN FALSE ELSE TRUE END AS `Prescribed medication containing metoprolol tartrate?`, "
            ...
            + "ON patientMedicationRequestAsSubjectMedicationCodeableConceptCodingExploded.patientMedicationRequestAsSubjectMedicationCodeableConceptCoding.system = patientMedicationRequestAsSubjectMedicationCodeableConceptCodingValueSet.system "
            + "AND patientMedicationRequestAsSubjectMedicationCodeableConceptCodingExploded.patientMedicationRequestAsSubjectMedicationCodeableConceptCoding.code = patientMedicationRequestAsSubjectMedicationCodeableConceptCodingValueSet.code "
            + "GROUP BY 1, 2"
  ...
  public void multipleGroupingsOnInValueSetInput() throws IOException {
    ...
    String expectedSql =
        "SELECT conditionCodeCodingValueSetAggregated.`Condition type` AS `Condition type`, "
            + "CASE WHEN conditionCodeCodingValueSetAggregated.code IS NULL THEN FALSE ELSE TRUE END AS `Is it a type of fracture?`, "
            + "COUNT(DISTINCT conditionCodeCodingValueSetAggregated.`Number of conditions`) AS `Number of conditions` "
            + "FROM ("
            + "SELECT conditionCodeCoding.display AS `Condition type`, "
            + "condition.id AS `Number of conditions`, "
            + "MAX(conditionCodeCodingValueSet.code) AS code "
            + "FROM condition "
            + "LEFT JOIN ("
            + "SELECT * "
            + "FROM condition LATERAL VIEW OUTER explode(condition.code.coding) conditionCodeCoding AS conditionCodeCoding"
            + ") conditionCodeCodingExploded ON condition.id = conditionCodeCodingExploded.id "
            + "LEFT JOIN `valueSet_ce36080a2c52a33c18c6b94080da1cb4` conditionCodeCodingValueSet "
            + "ON conditionCodeCodingExploded.conditionCodeCoding.system = conditionCodeCodingValueSet.system "
            + "AND conditionCodeCodingExploded.conditionCodeCoding.code = conditionCodeCodingValueSet.code "
            + "GROUP BY 1, 2"
            + ") conditionCodeCodingValueSetAggregated "
            + "GROUP BY 1, 2 "
            + "ORDER BY 1, 2, 3";

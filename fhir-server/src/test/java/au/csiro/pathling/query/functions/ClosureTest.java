...
import au.csiro.pathling.query.functions.Closure.CodingSet;
...
public class ClosureTest {
  ...
  public void testUnversionedClosure() {
    Closure versionedClosure =
        Closure.fromMappings(Arrays.asList(new Mapping(CODING1_UNVERSIONED, CODING2_UNVERSIONED)));
  ...
  public void testVersionedClosure() {
    ...
    List<Mapping> mappings = Arrays.asList(new Mapping(CODING1_VERSION1, CODING2_VERSION1));

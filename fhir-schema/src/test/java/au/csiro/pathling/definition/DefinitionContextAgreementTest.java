...
/**
 * Tests that the two implementations of the abstraction describe the same resource in the same way.
 */
  ...
  private static final DefinitionContext EXPLICIT_DEFINITIONS =
      DefaultDefinitionContext.of(
          DefaultResourceDefinition.of(
              ...
              DefaultPrimitiveDefinition.single("id", FHIRDefinedType.ID),
              DefaultPrimitiveDefinition.single("meta", FHIRDefinedType.META),
              DefaultPrimitiveDefinition.single("implicitRules", FHIRDefinedType.URI),
              DefaultPrimitiveDefinition.single("language", FHIRDefinedType.CODE),
              DefaultPrimitiveDefinition.single("text", FHIRDefinedType.NARRATIVE),
              DefaultPrimitiveDefinition.of("contained", FHIRDefinedType.RESOURCE, -1),
              DefaultPrimitiveDefinition.of("extension", FHIRDefinedType.EXTENSION, -1),
              DefaultPrimitiveDefinition.of("modifierExtension", FHIRDefinedType.EXTENSION, -1),
              DefaultPrimitiveDefinition.of("identifier", FHIRDefinedType.IDENTIFIER, -1),
              DefaultPrimitiveDefinition.single("code", FHIRDefinedType.CODEABLECONCEPT),
              DefaultPrimitiveDefinition.single("subject", FHIRDefinedType.REFERENCE),
              DefaultPrimitiveDefinition.single("created", FHIRDefinedType.DATETIME),
              DefaultPrimitiveDefinition.single("author", FHIRDefinedType.REFERENCE)));

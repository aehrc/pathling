 ...
 * enumeration does not contain. A dense schema visits every element the definitions describe, so
 * such a code would fail derivation outright rather than a single query.
 */

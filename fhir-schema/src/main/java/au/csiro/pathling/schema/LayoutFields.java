...
public final class LayoutFields {
  ...
  /**
   * Returns the names of the layout's own fields that sit beside a field of the given type, in the
   * order they appear after it: the metadata group where the type is primitive, then the
   * annotations.
   *
   * @param fieldName the name of the field they accompany
   * @param type the FHIR type of that field
   * @return the sibling names, in order
   */
  @Nonnull

 ...
 *
 * <p>Two of these deserve note. A decimal is stored as text so that its lexical form survives the
 * round trip: trailing zeros, exponent notation and arbitrary digit counts all compare lexically,
 * and the numeric annotation supplies the value where one is needed. A date or time is likewise
 * stored in the lexical form of the source, because the stated precision is part of the value.
 */
public final class PrimitiveTypes {
  ...
  private static final Map<String, DataType> TYPES =
      Map.ofEntries(
          ...
          Map.entry("base64Binary", DataTypes.StringType),

...
and every `output[].url` discovered within fetched manifests. A manifest served
from an allowlisted source that references file URLs on a different host will be

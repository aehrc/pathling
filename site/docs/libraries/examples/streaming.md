...
- **Code translation**: Uses [`translate`](/docs/fhirpath/extension-functions#translate) to map
  SNOMED CT to ICD-10-AM via a ConceptMap
- **Concept subsumption**: Uses [`subsumedBy`](/docs/fhirpath/fhir-functions#subsumedby) to

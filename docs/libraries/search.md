...
## Basic filtering[​](#basic-filtering "Direct link to Basic filtering")
...
### AND logic[​](#and-logic "Direct link to AND logic")
...
### OR logic[​](#or-logic "Direct link to OR logic")
...
## Comparison prefixes[​](#comparison-prefixes "Direct link to Comparison prefixes")
...
### Date comparisons[​](#date-comparisons "Direct link to Date comparisons")
...
### Quantity comparisons[​](#quantity-comparisons "Direct link to Quantity comparisons")
...
## Search parameter types[​](#search-parameter-types "Direct link to Search parameter types")

Different FHIR search parameter types support different matching behaviours.

### Quantity parameters[​](#quantity-parameters "Direct link to Quantity parameters")
...
### String parameters[​](#string-parameters "Direct link to String parameters")
...
### Reference parameters[​](#reference-parameters "Direct link to Reference parameters")
...
### Number parameters[​](#number-parameters "Direct link to Number parameters")
...
### URI parameters[​](#uri-parameters "Direct link to URI parameters")
...
### :not<!-- --> modifier[​](#-modifier "Direct link to -modifier")
...
### :exact<!-- --> modifier[​](#-modifier-1 "Direct link to -modifier-1")
...
## FHIRPath expressions[​](#fhirpath-expressions "Direct link to FHIRPath expressions")

For more complex filtering requirements beyond what search parameters support, you can use FHIRPath expressions directly.

### Using fhirpath\_to\_column[​](#using-fhirpath_to_column "Direct link to Using fhirpath_to_column")
...
## Combining filters[​](#combining-filters "Direct link to Combining filters")
...
## Empty query[​](#empty-query "Direct link to Empty query")

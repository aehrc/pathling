...
## Understanding the repeat directive[​](#understanding-the-repeat-directive "Direct link to Understanding the repeat directive")
...
## Load QuestionnaireResponse data[​](#load-questionnaireresponse-data "Direct link to Load QuestionnaireResponse data")
...
## Flattening nested items with repeat[​](#flattening-nested-items-with-repeat "Direct link to Flattening nested items with repeat")
...
| id                  | questionnaire                         | patient\_id | authored                  | item\_link\_id | item\_text         | answer\_value\_string | answer\_value\_integer | answer\_value\_boolean | answer\_value\_date |
| ------------------- | ------------------------------------- | ----------- | ------------------------- | -------------- | ------------------ | --------------------- | ---------------------- | ---------------------- | ------------------- |
...
## Filtering nested items[​](#filtering-nested-items "Direct link to Filtering nested items")
...
## Comparison with forEach[​](#comparison-with-foreach "Direct link to Comparison with forEach")
...
## Other use cases[​](#other-use-cases "Direct link to Other use cases")
...
## Understanding traversal depth limits[​](#understanding-traversal-depth-limits "Direct link to Understanding traversal depth limits")
...
### When the depth limit applies[​](#when-the-depth-limit-applies "Direct link to When the depth limit applies")
...
### When the depth limit does NOT apply[​](#when-the-depth-limit-does-not-apply "Direct link to When the depth limit does NOT apply")
...
### Configuring the depth limit[​](#configuring-the-depth-limit "Direct link to Configuring the depth limit")
...
### Why this limit exists[​](#why-this-limit-exists "Direct link to Why this limit exists")

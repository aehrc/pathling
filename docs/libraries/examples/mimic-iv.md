...
This article demonstrates how to extract and prepare clinical data from MIMIC-IV using Pathling. We use a [clinical study](https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2794196) on oxygen supplementation differences between racial groups as our example, focusing on the data preparation steps that transform raw healthcare records into analysis-ready datasets.

This work was originally published as part of the paper [SQL on FHIR - Tabular views of FHIR data using FHIRPath](https://www.nature.com/articles/s41746-025-01708-w) published in [npj Digital Medicine](https://www.nature.com/npjdigitalmed/). The full code is available in the [aehrc/sql-on-fhir-evaluation](https://github.com/aehrc/sql-on-fhir-evaluation) repository.
...
## Importing the MIMIC-IV dataset[​](#importing-the-mimic-iv-dataset "Direct link to Importing the MIMIC-IV dataset")
...
* [The full dataset](https://physionet.org/content/mimic-iv-fhir/2.1/) (approximately 625M resources). This dataset requires credentialed access and the use must accept a data use agreement which includes a mandatory training course.
* [A demo sample](https://physionet.org/content/mimic-iv-fhir-demo/2.1.0/) (approximately 1M resources).
...
## Understanding the data extraction approach[​](#understanding-the-data-extraction-approach "Direct link to Understanding the data extraction approach")

### Layered data transformation[​](#layered-data-transformation "Direct link to Layered data transformation")

<!-- -->

![](<> "Views used to transform
raw FHIR data into tables ready for analysis") ![](<> "Views used to
transform raw FHIR data into tables ready for analysis")
...
## SQL on FHIR views[​](#sql-on-fhir-views "Direct link to SQL on FHIR views")
...
### Patient demographics (`rv_patient.json`)[​](#patient-demographics-rv_patientjson "Direct link to patient-demographics-rv_patientjson")
...
### ICU encounter details (`rv_icu_encounter.json`)[​](#icu-encounter-details-rv_icu_encounterjson "Direct link to icu-encounter-details-rv_icu_encounterjson")
...
### Vital signs measurements (`rv_obs_vitalsigns.json`)[​](#vital-signs-measurements-rv_obs_vitalsignsjson "Direct link to vital-signs-measurements-rv_obs_vitalsignsjson")
...
### Oxygen flow measurements (`rv_obs_o2_flow.json`)[​](#oxygen-flow-measurements-rv_obs_o2_flowjson "Direct link to oxygen-flow-measurements-rv_obs_o2_flowjson")
...
### Oxygen delivery devices (`rv_o2_delivery_device.json`)[​](#oxygen-delivery-devices-rv_o2_delivery_devicejson "Direct link to oxygen-delivery-devices-rv_o2_delivery_devicejson")
...
### Blood gas measurements (`rv_obs_bg.json`)[​](#blood-gas-measurements-rv_obs_bgjson "Direct link to blood-gas-measurements-rv_obs_bgjson")
...
## Building clinical concepts from SQL on FHIR views[​](#building-clinical-concepts-from-sql-on-fhir-views "Direct link to Building clinical concepts from SQL on FHIR views")
...
### Vital signs processing (`md_vitalsigns.sql`)[​](#vital-signs-processing-md_vitalsignssql "Direct link to vital-signs-processing-md_vitalsignssql")
...
### Oxygen delivery processing (`md_oxygen_delivery.sql`)[​](#oxygen-delivery-processing-md_oxygen_deliverysql "Direct link to oxygen-delivery-processing-md_oxygen_deliverysql")
...
### Blood gas analysis processing (`md_bg.sql`)[​](#blood-gas-analysis-processing-md_bgsql "Direct link to blood-gas-analysis-processing-md_bgsql")
...
## Creating study-specific datasets[​](#creating-study-specific-datasets "Direct link to Creating study-specific datasets")
...
### Defining the study population (`st_subject.sql`)[​](#defining-the-study-population-st_subjectsql "Direct link to defining-the-study-population-st_subjectsql")
...
### Extracting oxygen flow measurements (`st_reading_o2_flow.sql`)[​](#extracting-oxygen-flow-measurements-st_reading_o2_flowsql "Direct link to extracting-oxygen-flow-measurements-st_reading_o2_flowsql")
...
### Extracting pulse oximetry readings (`st_reading_spo2.sql`)[​](#extracting-pulse-oximetry-readings-st_reading_spo2sql "Direct link to extracting-pulse-oximetry-readings-st_reading_spo2sql")
...
### Extracting blood oxygen measurements (`st_reading_so2.sql`)[​](#extracting-blood-oxygen-measurements-st_reading_so2sql "Direct link to extracting-blood-oxygen-measurements-st_reading_so2sql")
...
## Running the data extraction process[​](#running-the-data-extraction-process "Direct link to Running the data extraction process")

The data extraction system processes these layered views using Pathling's datasources API.

### Processing the view definitions[​](#processing-the-view-definitions "Direct link to Processing the view definitions")
...
### Running study-specific views and exporting to CSV[​](#running-study-specific-views-and-exporting-to-csv "Direct link to Running study-specific views and exporting to CSV")
...
### Output datasets[​](#output-datasets "Direct link to Output datasets")
...
* [SQL on FHIR - Tabular views of FHIR data using FHIRPath](https://www.nature.com/articles/s41746-025-01708-w) - Original research paper demonstrating these techniques
* [aehrc/sql-on-fhir-evaluation](https://github.com/aehrc/sql-on-fhir-evaluation) - Full code repository for this example
* [SQL on FHIR example](/docs/libraries/examples/prostate-cancer.md) - More examples of SQL on FHIR queries

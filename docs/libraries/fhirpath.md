...
## Boolean filtering[​](#boolean-filtering "Direct link to Boolean filtering")
...
## Value extraction[​](#value-extraction "Direct link to Value extraction")
...
## Combining with other operations[​](#combining-with-other-operations "Direct link to Combining with other operations")

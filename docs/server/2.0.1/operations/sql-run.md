...
Long-running queries should use the asynchronous bulk submit path rather than the synchronous `$sqlquery-run` endpoint. See the [configuration reference](/docs/server/2.0.1/configuration.md) for the full list of options.

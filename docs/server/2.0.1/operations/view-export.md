...
Use this operation for large datasets that need to be exported asynchronously. For smaller, synchronous queries, see the [run view](/docs/server/2.0.1/operations/view-run.md) operation.

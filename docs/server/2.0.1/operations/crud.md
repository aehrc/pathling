...
There are a number of configuration values that affect the encoding of resources, see the [Encoding](/docs/server/2.0.1/configuration.md#encoding) section of the configuration documentation for details.
...
To perform multiple create, update, or delete operations in a single request, see the [Batch](/docs/server/2.0.1/operations/batch.md) documentation.

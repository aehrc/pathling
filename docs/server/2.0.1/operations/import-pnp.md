...
This implementation follows the [SMART Bulk Data Import - Ping and Pull Approach](https://github.com/smart-on-fhir/bulk-import/blob/master/import-pnp.md) proposal.
...
| `inputFormat` | 0..1        | Coding | The format of source files. Defaults to `application/fhir+ndjson`. See [Supported formats](/docs/server/2.0.1/operations/import.md#supported-formats). |
...
The operation uses the [FHIR Asynchronous Request Pattern](https://hl7.org/fhir/R4/async.html).
...
### Import PnP client[​](#import-pnp-client "Direct link to Import PnP client")

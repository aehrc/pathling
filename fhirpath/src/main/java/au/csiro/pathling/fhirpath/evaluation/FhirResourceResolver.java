...
public record FhirResourceResolver(
  ...
  private ResourceCollection createResourceCollection(@Nonnull final ResourceType resourceType) {
    return ResourceCollection.build(
        ResourceRepresentation.alwaysPresent(), fhirContext, resourceType);
  }
   ...
   */
  @Nonnull
  private ResourceCollection createEmptyResourceCollection(
   ...
   *
   * <p>This is used to distinguish between:
   *
   * <ul>
   *   <li>Valid FHIR resource types (e.g., "Patient", "Encounter") - returns the ResourceType
   *   <li>Invalid codes that represent fields (e.g., "CustomField") - returns empty
   * </ul>
   *

...
public class Projection {
   ...
   */
  @Nonnull String subjectResource;
  ...
  public Dataset<Row> execute(@Nonnull final ExecutionContext context) {
    ...
    final ProjectionContext projectionContext =
        ProjectionContext.of(context, subjectResource, constants);
    ...
    final Dataset<Row> filteredResult = filterColumn.map(unfiltered::filter).orElse(unfiltered);

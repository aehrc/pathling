...
public class SelectClause implements SelectionElement {
   ...
   */
  @Nonnull @NotNull @Valid List<@Valid Column> column = Collections.emptyList();
   ...
   */
  @Nonnull @NotNull @Size() @Valid List<@Valid SelectClause> select = Collections.emptyList();
   ...
   * recursively apply the same path patterns. This continues until no more matches are found at any
   * depth. All results from all levels and all paths are unioned together.
   *
   * @see <a
   ...
   */
  @Nonnull @NotNull @Size() @Valid @CompatibleUnionColumns

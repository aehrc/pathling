...
/**
 * Maps FHIR and FHIRPath types to Spark SQL DataTypes and provides conversion functions, with
 * support for ANSI SQL type hints.
 */
public class TypeHintMapper {
  ...
  public static Column convertCollectionColumn(
    ...
    return getDefaultConverter(collection).apply(collection.getColumn());
  }
  ...
  public static Column convertCollectionColumn(
    ...
    return makeCast(typeHint).apply(collection.getColumn());
  }

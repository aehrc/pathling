...
/**
 * Matches elements using exact equality for token search parameters.
 * <p>
 * Token matching is case-sensitive and requires exact equality between the element value and the
 * search value.
 *

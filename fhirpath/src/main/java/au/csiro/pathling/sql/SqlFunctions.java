...
public interface SqlFunctions {
     ...
     * <p>
     * This function is designed to be used in Spark SQL aggregation operations to combine
     * multiple maps into a single map. It handles null values appropriately and ensures
     * that when maps contain the same keys, the last value wins.
     * <p>

...
public class TypeFunctionsDslTest extends FhirPathDslTestBase {
            ...
            sb ->
                sb
                    ...
                    .element(
                        "quantityValue",
                        qt ->
                            qt.fhirType(FHIRDefinedType.QUANTITY)
                                .decimal("value", 11.5)
                                .string("unit", "mg"))
  ...
  public Stream<DynamicTest> testAsFunction() {
    return builder()
        ...
        .testEquals(
            "mg", "(11.5 'mg').as(FHIR.Quantity).unit", "as() works with explicit FHIR namespace")
        .testEquals(
            "code2",
            "codingValue.as(FHIR.Coding).code",
            "as() returns Coding value and allows traversal")
        .testEquals(
            "code2", "codingValue.as(System.Coding).code", "as() works with System namespace")
        .group("as() function - namespace variations")
        // Test namespace handling
        .testEquals("11 'mg'", "(11 'mg').as(Quantity)", "as() works with unqualified type name")
        .testEquals(
            "12 'cm'",

...
class FhirPathQuantityTest {
  ...
  static Stream<Arguments> quantityLiterals() {
    return Stream.of(
        ...
        Arguments.of(
            "1 year", FhirPathQuantity.ofUnit(new BigDecimal("1"), CalendarDurationUnit.YEAR)),
        Arguments.of(
            "2 years",
            FhirPathQuantity.ofUnit(new BigDecimal("2"), CalendarDurationUnit.YEAR, "years")),
        Arguments.of(
            "3 month", FhirPathQuantity.ofUnit(new BigDecimal("3"), CalendarDurationUnit.MONTH)),
        Arguments.of(
            "4 months",
            FhirPathQuantity.ofUnit(new BigDecimal("4"), CalendarDurationUnit.MONTH, "months")),
        Arguments.of(
            "1 week", FhirPathQuantity.ofUnit(new BigDecimal("1"), CalendarDurationUnit.WEEK)),
        Arguments.of(
            "2 weeks",
            FhirPathQuantity.ofUnit(new BigDecimal("2"), CalendarDurationUnit.WEEK, "weeks")),
        Arguments.of(
            "5 day", FhirPathQuantity.ofUnit(new BigDecimal("5"), CalendarDurationUnit.DAY)),
        Arguments.of(
            "6 days",
            FhirPathQuantity.ofUnit(new BigDecimal("6"), CalendarDurationUnit.DAY, "days")),
        Arguments.of(
            "7 hour", FhirPathQuantity.ofUnit(new BigDecimal("7"), CalendarDurationUnit.HOUR)),
        Arguments.of(
            "8 hours",
            FhirPathQuantity.ofUnit(new BigDecimal("8"), CalendarDurationUnit.HOUR, "hours")),
        Arguments.of(
            "9 minute", FhirPathQuantity.ofUnit(new BigDecimal("9"), CalendarDurationUnit.MINUTE)),
        Arguments.of(
            "10 minutes",
            FhirPathQuantity.ofUnit(new BigDecimal("10"), CalendarDurationUnit.MINUTE, "minutes")),
        Arguments.of(
            "11 second",
            FhirPathQuantity.ofUnit(new BigDecimal("11"), CalendarDurationUnit.SECOND)),
        Arguments.of(
            "12 seconds",
            FhirPathQuantity.ofUnit(new BigDecimal("12"), CalendarDurationUnit.SECOND, "seconds")),
        Arguments.of(
            "13 millisecond",
        ...
        Arguments.of(
            ...
            FhirPathQuantity.ofUnit(
                new BigDecimal("14"), CalendarDurationUnit.MILLISECOND, "milliseconds")));
  }
  ...
  static Stream<Arguments> calendarDurationConversions() {
    return Stream.of(
        ...
        Arguments.of(
            CalendarDurationUnit.MINUTE, "minute", new BigDecimal("10"), new BigDecimal("10")),
        Arguments.of(
            CalendarDurationUnit.SECOND, "second", new BigDecimal("5"), new BigDecimal("5")),
        Arguments.of(
            CalendarDurationUnit.MILLISECOND,
            "millisecond",
            new BigDecimal("1000"),
            new BigDecimal("1000")),
        ...
        Arguments.of(
            CalendarDurationUnit.YEAR, "months", new BigDecimal("1"), new BigDecimal("12")),
        ...
        Arguments.of(
            CalendarDurationUnit.HOUR, "minutes", new BigDecimal("1"), new BigDecimal("60")),
        Arguments.of(
            CalendarDurationUnit.MINUTE, "seconds", new BigDecimal("1"), new BigDecimal("60")),
        Arguments.of(
            CalendarDurationUnit.SECOND,
            "milliseconds",
            new BigDecimal("1"),
            new BigDecimal("1000")),
        ...
        Arguments.of(
            CalendarDurationUnit.MONTH, "years", new BigDecimal("12"), new BigDecimal("1")),
        ...
        Arguments.of(
            CalendarDurationUnit.MINUTE, "hours", new BigDecimal("60"), new BigDecimal("1")),
        Arguments.of(
            CalendarDurationUnit.SECOND, "minutes", new BigDecimal("60"), new BigDecimal("1")),
        Arguments.of(
            CalendarDurationUnit.MILLISECOND,
            "seconds",
            new BigDecimal("1000"),
        ...
        // year -> day -> hour
        Arguments.of(
            CalendarDurationUnit.YEAR, "hours", new BigDecimal("1"), new BigDecimal("8760")),
        // year -> day -> hour -> minute
        Arguments.of(
            CalendarDurationUnit.YEAR, "minutes", new BigDecimal("1"), new BigDecimal("525600")),
        // year -> day -> hour -> minute -> second
        Arguments.of(
            CalendarDurationUnit.YEAR, "seconds", new BigDecimal("1"), new BigDecimal("31536000")),
        // year -> day -> hour -> minute -> second -> millisecond
        Arguments.of(
            CalendarDurationUnit.YEAR,
            "milliseconds",
            new BigDecimal("1"),
        ...
        // month -> day -> hour
        Arguments.of(
            CalendarDurationUnit.MONTH, "hours", new BigDecimal("1"), new BigDecimal("720")),
        // month -> day -> hour -> minute
        Arguments.of(
            CalendarDurationUnit.MONTH, "minutes", new BigDecimal("1"), new BigDecimal("43200")),
        // month -> day -> hour -> minute -> second
        Arguments.of(
            CalendarDurationUnit.MONTH, "seconds", new BigDecimal("1"), new BigDecimal("2592000")),
        // month -> day -> hour -> minute -> second -> millisecond
        Arguments.of(
            CalendarDurationUnit.MONTH,
            "milliseconds",
            new BigDecimal("1"),
        ...
        // week -> day -> hour
        Arguments.of(
            CalendarDurationUnit.WEEK, "hours", new BigDecimal("1"), new BigDecimal("168")),
        // week -> day -> hour -> minute
        Arguments.of(
            CalendarDurationUnit.WEEK, "minutes", new BigDecimal("1"), new BigDecimal("10080")),
        // week -> day -> hour -> minute -> second
        Arguments.of(
            CalendarDurationUnit.WEEK, "seconds", new BigDecimal("1"), new BigDecimal("604800")),
        // week -> day -> hour -> minute -> second -> millisecond
        Arguments.of(
            CalendarDurationUnit.WEEK,
            "milliseconds",
            new BigDecimal("1"),
        ...
        // day -> hour -> minute
        Arguments.of(
            CalendarDurationUnit.DAY, "minutes", new BigDecimal("1"), new BigDecimal("1440")),
        // day -> hour -> minute -> second
        Arguments.of(
            CalendarDurationUnit.DAY, "seconds", new BigDecimal("1"), new BigDecimal("86400")),
        // day -> hour -> minute -> second -> millisecond
        Arguments.of(
            CalendarDurationUnit.DAY,
            "milliseconds",
            new BigDecimal("1"),
        ...
        // hour -> minute -> second
        Arguments.of(
            CalendarDurationUnit.HOUR, "seconds", new BigDecimal("1"), new BigDecimal("3600")),
        // hour -> minute -> second -> millisecond
        Arguments.of(
            CalendarDurationUnit.HOUR,
            "milliseconds",
            new BigDecimal("1"),
        ...
        Arguments.of(
            CalendarDurationUnit.SECOND, "ms", new BigDecimal("1"), new BigDecimal("1000")),
        Arguments.of(
            CalendarDurationUnit.MILLISECOND, "ms", new BigDecimal("1500"), new BigDecimal("1500")),
        ...
        Arguments.of(
            CalendarDurationUnit.MONTH, "s", new BigDecimal("1"), new BigDecimal("2592000")),
        Arguments.of(
            CalendarDurationUnit.YEAR, "s", new BigDecimal("1"), new BigDecimal("31536000")),

        // All calendar units can convert to 'ms' via: calendar → millisecond → 'ms'
        Arguments.of(
            CalendarDurationUnit.MINUTE, "ms", new BigDecimal("1"), new BigDecimal("60000")),
        Arguments.of(
            CalendarDurationUnit.HOUR, "ms", new BigDecimal("1"), new BigDecimal("3600000")),
        Arguments.of(
            CalendarDurationUnit.DAY, "ms", new BigDecimal("1"), new BigDecimal("86400000")),
        ...
        // - Calendar month = 30d = 2592000s, UCUM 'mo' = 30.4375d = 2629800s → NOT 1:1 but
        // convertible
        // - Calendar year = 365d = 31536000s, UCUM 'a' = 365.25d = 31557600s → NOT 1:1 but
        // convertible
  ...
  void testCalendarDurationConversion(
      final CalendarDurationUnit sourceUnit,
    ...
    assertEquals(
        0,
        expectedValue.compareTo(result.getValue()),
        String.format(
            "Converting %s %s to %s should produce %s, but got %s",
    ...
    if (isCalendarDuration) {
      ...
      assertEquals(UcumUnit.UCUM_SYSTEM_URI, result.getSystem(), "Result should be UCUM system");
      assertEquals(targetUnit, result.getUnitName(), "Result unit should be " + targetUnit);
    }
  }
  ...
  void testUcumToCalendarDurationConversion(
      final String sourceUcumUnit,
    ...
    assertEquals(
        ...
        "Result should be calendar duration system");
    assertEquals(
        targetCalendarUnit, result.getUnitName(), "Result unit should be " + targetCalendarUnit);
  }
  ...
  void testUnsupportedCalendarDurationConversion(
      final CalendarDurationUnit sourceUnit, final String targetUnit) {
    ...
    assertNull(
        result,
        String.format(
            "Converting %s to %s should return null (not supported)",
  ...
  void testUnsupportedUcumToCalendarConversion(
      final String sourceUcumUnit, final String targetCalendarUnit) {
    ...
    assertNull(
        result,
        String.format(
            "Converting UCUM '%s' to calendar '%s' should return null (not supported)",
  ...
  void testUcumConversion(
    ...
    assertNotNull(
        result,
        String.format(
            "Converting %s '%s' to '%s' should succeed", sourceValue, sourceUnit, targetUnit));
    assertEquals(
        0,
        expectedValue.compareTo(result.getValue()),
        String.format(
  ...
  void testUcumCanonicalization(
      final String sourceUnit,
      final BigDecimal sourceValue,
      final String expectedCanonicalUnit,
      final BigDecimal expectedCanonicalValue) {
    final FhirPathQuantity source = FhirPathQuantity.ofUcum(sourceValue, sourceUnit);
    final FhirPathQuantity canonical = source.asCanonical().orElse(null);

    assertNotNull(
        canonical, String.format("Canonicalizing %s '%s' should succeed", sourceValue, sourceUnit));
    assertEquals(
        expectedCanonicalUnit,
        canonical.getUnitName(),
        String.format("Canonical unit should be '%s'", expectedCanonicalUnit));
    assertEquals(
        0,
        expectedCanonicalValue.compareTo(canonical.getValue()),
        String.format(
            "Canonical value should be %s, but got %s",
            expectedCanonicalValue, canonical.getValue()));
    assertEquals(
        UcumUnit.UCUM_SYSTEM_URI,
        canonical.getSystem(),
  ...
  static Stream<Arguments> calendarDurationCanonicalization() {
    return Stream.of(
        ...
        Arguments.of(
            CalendarDurationUnit.MILLISECOND, new BigDecimal("1000"), "s", new BigDecimal("1")));
  }

  @ParameterizedTest
  @MethodSource("calendarDurationCanonicalization")
  void testCalendarDurationCanonicalization(
      final CalendarDurationUnit sourceUnit,
      final BigDecimal sourceValue,
      final String expectedCanonicalUnit,
      final BigDecimal expectedCanonicalValue) {
  ...
  void testIndefiniteCalendarDurationCanonicalization(
      final CalendarDurationUnit sourceUnit, final BigDecimal sourceValue) {
    final FhirPathQuantity source = FhirPathQuantity.ofUnit(sourceValue, sourceUnit);
    ...
    assertNull(
        canonical,
        String.format(
            "Canonicalizing indefinite duration %s %s should return null",

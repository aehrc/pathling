...
public class EqualityOperatorsDslTest extends FhirPathDslTestBase {
  ...
  public Stream<DynamicTest> testBooleanEquality() {
    return builder()
        .withSubject(
            sb ->
                sb.boolArray("allTrue", true, true)
  ...
  public Stream<DynamicTest> testDateAndDateTimeEquality() {
    return builder()
        .withSubject(
            sb ->
                sb.dateArray("dateArray1", "2020-01-01", "2020-01-02")
                    ...
                    .dateTimeArray(
                        "dtArray1", "2020-01-01T10:00:00+00:00", "2020-01-01T11:00:00+00:00")
                    .dateTimeArray(
                        "dtArray2", "2020-01-01T10:00:00+00:00", "2020-01-01T10:00:00+00:00")
        ...
        .testEmpty(
            "@2020-01-01 != @2020-01-01.where(false)", "date literal not equals computed empty")
        ...
        .testFalse(
            "dateArray3 = @2020-01-01", "array equals singleton (one comparable, one incomparable)")
        ...
        .testTrue(
            "@2020-01-01T10:00:00+00:00 = @2020-01-01T10:00:00+00:00",
        ...
        .testTrue(
            "@2020-01-01T10:00:00+00:00 = @2020-01-01T10:00:00",
            "dateTime literal equals different one with timezone vs no timezone")
        .testFalse(
            "@2020-01-01T10:00:00+00:00 != @2020-01-01T10:00:00.000",
            "dateTime literal equals different one with fractional seconds vs no fractional"
                + " seconds")
        .testEmpty(
            "@2020-01-01T10:00:00 = @2020-01-01T10:00",
        ...
        .testEmpty(
            "@2020-01-01T10:00:00+00:00 = @2020-01-01T10:00:00+00:00.where(false)",
        ...
        .testFalse(
            "dtArray1 = @2020-01-01T10:00:00+00:00",
            "array equals singleton (one matches, one does not)")
        .testTrue(
            "dtArray2 != @2020-01-01T10:00:00+00:00", "array differs from singleton (all match)")
        .group("DateTime equality: array vs singleton, some incomparable")
        .testFalse(
            "dtArray3 = @2020-01-01T10:00:00+00:00",
        ...
        .testFalse(
            "dateArray1 = dtArray1", "date array equals dateTime array (all match at midnight)")
  ...
  public Stream<DynamicTest> testCodingEquality() {
    return builder()
        ...
        .testEmpty(
            "http://loinc.org|8867-4||'Heart rate' = {}", "coding literal equals explicit empty")
        .testEmpty(
            "http://loinc.org|8867-4||'Heart rate' != {}",
            "coding literal not equals explicit empty")
        .group("Coding equality: singleton vs computed empty")
        .testEmpty(
            "http://loinc.org|8867-4||'Heart rate' = http://loinc.org|8867-4||'Heart"
                + " rate'.where(false)",
        ...
        .testTrue(
            "manyCoding != http://loinc.org|8867-4||'Heart rate'",
            "coding array differs singleton literal (one match)")
        .testFalse(
            "manyCoding = http://loinc.org|9999-9||'Other'",
  ...
  public Stream<DynamicTest> testQuantityEquality() {
    return builder()
        .withSubject(sb -> sb.stringEmpty("str"))
        ...
        .testTrue(
            "8 milliseconds = 8 milliseconds", "Calendar: 8 milliseconds equals 8 milliseconds")
        .testFalse(
            "8 milliseconds != 8 milliseconds",
        ...
        .testFalse(
            "1 millisecond != 0.001 second", "Calendar: 1 millisecond not unequal to 0.001 second")
        ...
        .testFalse(
            "59 seconds = 1 'min'", "Calendar/UCUM: 59 seconds not equals 1 min (comparable)")
        ...
        .testEmpty("1 year != 1 'a'", "Calendar/UCUM: year and UCUM 'a' are not comparable (empty)")
        .group(
            "Quantity equality: Calendar duration and non-time UCUM cross-comparisons (not"
                + " comparable)")

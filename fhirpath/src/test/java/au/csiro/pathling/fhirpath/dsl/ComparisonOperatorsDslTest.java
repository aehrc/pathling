...
public class ComparisonOperatorsDslTest extends FhirPathDslTestBase {
  ...
  public Stream<DynamicTest> testCalendarComparison() {
    return builder()
        .withSubject(sb -> sb.stringEmpty("strEmpty"))
        ...
        .testTrue(
            "@2020-03-01 >= @2020-02", "Comparable partial date different precision greater than")
        .testEmpty(
            "@2020 <= @2020-01", "Incomparable partials dates less than with different precisions")
        .group("DateTime comparison")
        .testTrue(
            "@2020-01-01T10:00:00+00:00 < @2020-01-01T11:00:00+00:00", "Full DateTimes less than")
        .testFalse(
            "@2020-01-01T12:00 < @2020-01-01T11:00",
            "Partial same precision DateTimes less than false case")
        .testTrue(
            "@2020-01-01T12:00 >= @2020-01-01T11", "Comparable partial date different precision >=")
        .testFalse(
            "@2018-03-01T10:30:00 > @2018-03-01T10:30:00.0",
            "Seconds and miliseconds precision can be compared")
        .testEmpty(
            "@2020-01-01T12:00 <= @2020-01-01T12",
        ...
        .testEmpty(
            "@2020-01-01 < @2020-01-01T10:00:00Z", "Same full uncomparable Date and DateTime")
        ...
        .testEmpty(
            "@2018-03-01 < @2018-03-02T00:00:00+01:00", "Uncomparable due to timezone after UTC")
        .build();
  }
  ...
  public Stream<DynamicTest> testQuantityComparison() {
    return builder()
        ...
        .testFalse(
            "500 'mg' >= 1 'g'", "500 mg not greater than or equal to 1 g (compatible units)")
        ...
        .testTrue(
            "1000 milliseconds < 2000 milliseconds",
        ...
        .testTrue(
            "31557600 's' >= 1 'a'",
            "31557600 seconds greater or equal to 1 UCUM year (comparable because calendar unit is"
                + " ≤ seconds)")
        .testFalse(
            "1000 milliseconds > 1 'wk'",
            "1000 milliseconds not greater than 1 UCUM week (comparable because calendar unit is ≤"
                + " seconds)")
        .testTrue(
            "1 second <= 1 'mo'",
            "1 second less than or equal to 1 UCUM month (comparable because calendar unit is ≤"
                + " seconds)")
        .testTrue(
            "500 milliseconds < 1 'min'",
            "500 milliseconds less than 1 UCUM minute (comparable because calendar unit is ≤"
                + " seconds)")
        .group("Calendar duration and UCUM cross-comparisons (calendar > seconds, not comparable)")
        .testEmpty(
            "1 year > 1 'a'", "year and UCUM 'a' are not comparable (calendar unit > seconds)")
        .testEmpty(
            "1 month < 1 'mo'", "month and UCUM 'mo' are not comparable (calendar unit > seconds)")
        .testEmpty(
            "1 week <= 1 'wk'", "week and UCUM 'wk' are not comparable (calendar unit > seconds)")
        .testEmpty(
            "1 day >= 1 'd'", "day and UCUM 'd' are not comparable (calendar unit > seconds)")
        .testEmpty(
            "1 hour < 1 'h'", "hour and UCUM 'h' are not comparable (calendar unit > seconds)")
        .testEmpty(
            "1 minute > 1 'min'",
        ...
        .testEmpty(
            "1 year > 1 'mg'", "calendar year and UCUM mg are not comparable (non-time UCUM)")
        .testEmpty(
            "10 hours < 1 'cm'", "calendar hour and UCUM cm are not comparable (non-time UCUM)")
        .testEmpty(
            "5 seconds >= 1 'kg'", "calendar second and UCUM kg are not comparable (non-time UCUM)")
        .testEmpty(
            "100 milliseconds <= 1 'L'",

  ...
  public Stream<DynamicTest> testAsOperator() {
    return builder()
        ...
        .testEmpty("stringValue as Integer",
            "'as' operator returns empty when type doesn't match")
        .testEmpty("integerValue as Boolean",
            "'as' operator returns empty when value is different type")
        ...
        .testEmpty("emptyString as String",
            "'as' operator returns empty when applied to empty value")
        .testEmpty("{} as String",
            "'as' operator returns empty when applied to empty collection")

        // Multi-item collections should error
        .testError("stringArray as String",
            "'as' operator throws error on multi-item collection")
        ...
        .testEquals("test", "stringValue as String",
        ...
        .testEquals(11.0, "((11 'mg') as Quantity).value",
        ...
        .testTrue("(stringValue as String).exists()",
            "'as' operator result can be tested with exists()")
        .testFalse("(stringValue as Integer).exists()",

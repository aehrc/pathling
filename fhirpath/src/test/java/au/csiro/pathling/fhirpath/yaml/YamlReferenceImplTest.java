...
public class YamlReferenceImplTest extends YamlSpecTestBase {
  ...
  @YamlSpec("fhirpath/cases/3.2_paths.yaml")
  void testPaths(@Nonnull final RuntimeCase testCase) {
    run(testCase);
  }

  @YamlSpec("fhirpath/cases/4.1_literals.yaml")
  ...
  @YamlSpec("fhirpath/cases/6.2_comparision.yaml")
  void testComparision(@Nonnull final RuntimeCase testCase) {
    run(testCase);
  }

  @YamlSpec("fhirpath/cases/6.3_types.yaml")
  ...
  @YamlSpec("fhirpath/cases/7_aggregate.yaml")
  void testAggregate(@Nonnull final RuntimeCase testCase) {
    run(testCase);
  }

  @YamlSpec("fhirpath/cases/8_variables.yaml")

...
public class ConversionFunctionsDslTest extends FhirPathDslTestBase {
  ...
  public Stream<DynamicTest> testToQuantity() {
    return builder()
        ...
        .testEquals(
            toQuantity("1 '1'"), "true.toQuantity()", "toQuantity() converts true to 1.0 '1'")
        .testEquals(
            toQuantity("0 '1'"), "false.toQuantity()", "toQuantity() converts false to 0.0 '1'")

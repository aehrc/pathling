...
public class ConversionFunctionsDslTest extends FhirPathDslTestBase {
  ...
  public Stream<DynamicTest> testToBoolean() {
    return builder()
        .withSubject(
            sb ->
                sb.boolArray("boolArray", true, false, true)
        ...
        .testError(
            "intArray.toBoolean()", "toBoolean() errors on array of convertible type (Integer)")
        .testError(
            "dateArray.toBoolean()", "toBoolean() errors on array of non-convertible type (Date)")
        .build();
  }
  ...
  public Stream<DynamicTest> testConvertsToBoolean() {
    return builder()
        .withSubject(
            sb ->
                sb.boolArray("boolArray", true, false)
        ...
        .testTrue("true.convertsToBoolean()", "convertsToBoolean() returns true for Boolean")
        .testTrue("'true'.convertsToBoolean()", "convertsToBoolean() returns true for 'true'")
        ...
        .testTrue("'false'.convertsToBoolean()", "convertsToBoolean() returns true for 'false'")
        .testTrue("1.convertsToBoolean()", "convertsToBoolean() returns true for 1")
        ...
        .testFalse(
            "'notBoolean'.convertsToBoolean()",
            "convertsToBoolean() returns false for invalid string")
        .testFalse("42.convertsToBoolean()", "convertsToBoolean() returns false for other integer")
        .testFalse(
            "3.14.convertsToBoolean()", "convertsToBoolean() returns false for other decimal")
        .testFalse("@2023-01-15.convertsToBoolean()", "convertsToBoolean() returns false for date")
        .group("convertsToBoolean() with empty values")
        .testEmpty(
            "emptyBool.convertsToBoolean()", "convertsToBoolean() returns empty for empty Boolean")
        .testEmpty(
            "emptyDec.convertsToBoolean()", "convertsToBoolean() returns empty for empty Decimal")
        .testEmpty(
            "emptyDate.convertsToBoolean()", "convertsToBoolean() returns empty for empty Date")
        .group("convertsToBoolean() error cases with arrays")
        .testEmpty(
            "{}.convertsToBoolean()", "convertsToBoolean() returns empty for empty collection")
        .testError(
            "boolArray.convertsToBoolean()",
            "convertsToBoolean() errors on array of source type (Boolean)")
        .testError(
            "decArray.convertsToBoolean()",
            "convertsToBoolean() errors on array of convertible type (Decimal)")
        .testError(
            "dateArray.convertsToBoolean()",
  ...
  public Stream<DynamicTest> testToInteger() {
    return builder()
        .withSubject(
            sb ->
                sb.integerArray("intArray", 1, 2, 3)
        ...
        .testError(
            "stringArray.toInteger()", "toInteger() errors on array of convertible type (String)")
        .testError(
            "dateArray.toInteger()", "toInteger() errors on array of non-convertible type (Date)")
        .build();
  }
  ...
  public Stream<DynamicTest> testConvertsToInteger() {
    return builder()
        ...
        .testTrue("true.convertsToInteger()", "convertsToInteger() returns true for Boolean")
        .testTrue("42.convertsToInteger()", "convertsToInteger() returns true for Integer")
        .testTrue("'123'.convertsToInteger()", "convertsToInteger() returns true for valid string")
        .group("convertsToInteger() with non-convertible literals")
        .testFalse(
            "'notNumber'.convertsToInteger()",
            "convertsToInteger() returns false for invalid string")
        .testFalse("3.14.convertsToInteger()", "convertsToInteger() returns false for Decimal")
        .testFalse("@2023-01-15.convertsToInteger()", "convertsToInteger() returns false for Date")
        .group("convertsToInteger() with empty values")
        .testEmpty(
            "emptyInt.convertsToInteger()", "convertsToInteger() returns empty for empty Integer")
        .testEmpty(
            "emptyBool.convertsToInteger()", "convertsToInteger() returns empty for empty Boolean")
        .testEmpty(
            "emptyDate.convertsToInteger()", "convertsToInteger() returns empty for empty Date")
        .group("convertsToInteger() error cases with arrays")
        .testEmpty(
            "{}.convertsToInteger()", "convertsToInteger() returns empty for empty collection")
        .testError(
            "intArray.convertsToInteger()",
            "convertsToInteger() errors on array of source type (Integer)")
        .testError(
            "boolArray.convertsToInteger()",
            "convertsToInteger() errors on array of convertible type (Boolean)")
        .testError(
            "dateArray.convertsToInteger()",
  ...
  public Stream<DynamicTest> testToDecimal() {
    return builder()
        .withSubject(
            sb ->
                sb.decimalArray("decArray", 1.1, 2.2, 3.3)
        ...
        .testError(
            "intArray.toDecimal()", "toDecimal() errors on array of convertible type (Integer)")
        .testError(
            "dateArray.toDecimal()", "toDecimal() errors on array of non-convertible type (Date)")
        .build();
  }
  ...
  public Stream<DynamicTest> testToString() {
    return builder()
        .withSubject(
            sb ->
                sb.stringArray("stringArray", "hello", "world")
        ...
        .testError(
            "decArray.toString()", "toString() errors on array of convertible type (Decimal)")
  ...
  public Stream<DynamicTest> testConvertsToString() {
    return builder()
        ...
        .testTrue("'hello'.convertsToString()", "convertsToString() returns true for String")
        .testTrue("@2023-01-15.convertsToString()", "convertsToString() returns true for Date")
        .testTrue(
            "@2023-01-15T10:30:00Z.convertsToString()",
            "convertsToString() returns true for DateTime")
        .testTrue("@T10:30:00.convertsToString()", "convertsToString() returns true for Time")
        .group("convertsToString() with empty values")
        .testEmpty(
            "emptyStr.convertsToString()", "convertsToString() returns empty for empty String")
        .testEmpty(
            "emptyInt.convertsToString()", "convertsToString() returns empty for empty Integer")
        .testEmpty(
            "emptyDate.convertsToString()", "convertsToString() returns empty for empty Date")
  ...
  public Stream<DynamicTest> testToDate() {
    return builder()
        .withSubject(
            sb ->
                sb.dateArray("dateArray", "2023-01-15", "2023-12-25")
        ...
        .testError(
            "intArray.toDate()", "toDate() errors on array of non-convertible type (Integer)")
        .build();
  }
  ...
  public Stream<DynamicTest> testConvertsToDate() {
    return builder()
        ...
        .testTrue("'2023-01-15'.convertsToDate()", "convertsToDate() returns true for string")
        .testTrue("@2023-12-25.convertsToDate()", "convertsToDate() returns true for date")
        .group("convertsToDate() with non-convertible types")
        .testFalse(
            "'notADate'.convertsToDate()", "convertsToDate() returns false for invalid date string")
        ...
        .testError(
            "dateArray.convertsToDate()", "convertsToDate() errors on array of source type (Date)")
        .testError(
            "stringArray.convertsToDate()",
            "convertsToDate() errors on array of convertible type (String)")
        .testError(
            "intArray.convertsToDate()",
  ...
  public Stream<DynamicTest> testToDateTime() {
    return builder()
        .withSubject(
            sb ->
                sb.dateTimeArray("dateTimeArray", "2023-01-15T10:30:00Z", "2023-12-25T12:00:00Z")
        ...
        .testError(
            "dateTimeArray.toDateTime()", "toDateTime() errors on array of source type (DateTime)")
        .testError(
            "stringArray.toDateTime()", "toDateTime() errors on array of convertible type (String)")
        .testError(
            "intArray.toDateTime()",
  ...
  public Stream<DynamicTest> testConvertsToDateTime() {
    return builder()
        ...
        .testEmpty(
            "emptyStr.convertsToDateTime()", "convertsToDateTime() returns empty for empty String")
        .testEmpty(
            "emptyInt.convertsToDateTime()", "convertsToDateTime() returns empty for empty Integer")
        .group("convertsToDateTime() error cases with arrays")
        .testEmpty(
            "{}.convertsToDateTime()", "convertsToDateTime() returns empty for empty collection")
        .testError(
            "dateTimeArray.convertsToDateTime()",
            "convertsToDateTime() errors on array of source type (DateTime)")
        .testError(
            "stringArray.convertsToDateTime()",
            "convertsToDateTime() errors on array of convertible type (String)")
        .testError(
            "intArray.convertsToDateTime()",
  ...
  public Stream<DynamicTest> testToTime() {
    return builder()
        .withSubject(
            sb ->
                sb.timeArray("timeArray", "10:30:00", "12:00:00")
        ...
        .testError(
            "intArray.toTime()", "toTime() errors on array of non-convertible type (Integer)")
        .build();
  }
  ...
  public Stream<DynamicTest> testConvertsToTime() {
    return builder()
        ...
        .testTrue("'10:30:00'.convertsToTime()", "convertsToTime() returns true for time string")
        .testFalse(
            "'non-time'.convertsToTime()", "convertsToTime() returns false for non-time string")
        ...
        .testError(
            "timeArray.convertsToTime()", "convertsToTime() errors on array of source type (Time)")
        .testError(
            "stringArray.convertsToTime()",
            "convertsToTime() errors on array of convertible type (String)")
        .testError(
            "intArray.convertsToTime()",
  ...
  public Stream<DynamicTest> testConvertsToDecimal() {
    return builder()
        ...
        .testTrue("true.convertsToDecimal()", "convertsToDecimal() returns true for Boolean")
        .testTrue("42.convertsToDecimal()", "convertsToDecimal() returns true for Integer")
        .testTrue("3.14.convertsToDecimal()", "convertsToDecimal() returns true for Decimal")
        .testTrue(
            "'3.14159'.convertsToDecimal()", "convertsToDecimal() returns true for valid string")
        .group("convertsToDecimal() with non-convertible literals")
        .testFalse(
            "'notNumber'.convertsToDecimal()",
            "convertsToDecimal() returns false for invalid string")
        .group("convertsToDecimal() with empty values")
        .testEmpty(
            "emptyDec.convertsToDecimal()", "convertsToDecimal() returns empty for empty Decimal")
        .testEmpty(
            "emptyInt.convertsToDecimal()", "convertsToDecimal() returns empty for empty Integer")
        .testEmpty(
            "emptyDate.convertsToDecimal()", "convertsToDecimal() returns empty for empty Date")
        .group("convertsToDecimal() error cases with arrays")
        .testEmpty(
            "{}.convertsToDecimal()", "convertsToDecimal() returns empty for empty collection")
        .testError(
            "decArray.convertsToDecimal()",
            "convertsToDecimal() errors on array of source type (Decimal)")
        .testError(
            "stringArray.convertsToDecimal()",
            "convertsToDecimal() errors on array of convertible type (String)")
        .testError(
            "dateArray.convertsToDecimal()",
  ...
  public Stream<DynamicTest> testToQuantity() {
    return builder()
        ...
        .testEquals(
            "10 'mg'", "'10 \\'mg\\''.toQuantity()", "toQuantity() parses UCUM quantity string")
        .testEquals(
            "1.5 'kg'", "'1.5 \\'kg\\''.toQuantity()", "toQuantity() parses decimal UCUM quantity")
        .testEquals(
            "-5.2 'cm'",
            "'-5.2 \\'cm\\''.toQuantity()",
        ...
        .testEquals(
            "4 days", "'4 days'.toQuantity()", "toQuantity() parses calendar duration (days)")
        .testEquals(
            "1 year", "'1 year'.toQuantity()", "toQuantity() parses calendar duration (year)")
        .testEquals(
            "3 months", "'3 months'.toQuantity()", "toQuantity() parses calendar duration (months)")
        ...
        .testError(
            "intArray.toQuantity()", "toQuantity() errors on array of convertible type (Integer)")
        .testError(
            "decArray.toQuantity()", "toQuantity() errors on array of convertible type (Decimal)")
        .testError(
            "stringArray.toQuantity()", "toQuantity() errors on array of convertible type (String)")
        .testError(
            "dateArray.toQuantity()", "toQuantity() errors on array of non-convertible type (Date)")
        .build();
  }
  ...
  public Stream<DynamicTest> testToQuantityWithUnit() {
    return builder()
        .withSubject(
            sb ->
                sb.stringArray("stringArray", "1 'wk'", "1 'cm'", "1000 'g'")
                    .stringEmpty("emptyStr"))
        ...
        .testEmpty(
            "42.toQuantity('mg')", "toQuantity() with different unitCode returns empty for integer")
        .testEmpty(
            "3.14.toQuantity('kg')",
        ...
        .testEquals(
            "0.01 'g'", "'10 \\'mg\\''.toQuantity('g')", "toQuantity() converts mg to g (mass)")
        .testEquals(
            "10 'mm'", "'1 \\'cm\\''.toQuantity('mm')", "toQuantity() converts cm to mm (length)")
        .testEquals(
            "1000 'mL'", "'1 \\'L\\''.toQuantity('mL')", "toQuantity() converts L to mL (volume)")
        .testEquals(
            "273.15 'K'",
            "'0 \\'Cel\\''.toQuantity('K')",
        ...
        .testEquals(
            "1500 'ms'",
            "'1500 milliseconds'.toQuantity('ms')",
  ...
  public Stream<DynamicTest> testConvertsToQuantity() {
    return builder()
        ...
        .testTrue("true.convertsToQuantity()", "convertsToQuantity() returns true for Boolean")
        .group("convertsToQuantity() - Integer sources")
        .testTrue("42.convertsToQuantity()", "convertsToQuantity() returns true for Integer")
        .group("convertsToQuantity() - Decimal sources")
        .testTrue("3.14.convertsToQuantity()", "convertsToQuantity() returns true for Decimal")
        ...
        .testFalse(
            "'notQuantity'.convertsToQuantity()",
        ...
        .testFalse(
            "@2023-01-15.convertsToQuantity()", "convertsToQuantity() returns false for Date")
        .group("convertsToQuantity() - Empty values")
        .testEmpty(
            "emptyBool.convertsToQuantity()",
            "convertsToQuantity() returns empty for empty Boolean")
        .testEmpty(
            "emptyInt.convertsToQuantity()", "convertsToQuantity() returns empty for empty Integer")
        .testEmpty(
            "emptyStr.convertsToQuantity()", "convertsToQuantity() returns empty for empty String")
        .testEmpty(
            "emptyDate.convertsToQuantity()", "convertsToQuantity() returns empty for empty Date")
        .group("convertsToQuantity() - Error cases (arrays)")
        .testEmpty(
            "{}.convertsToQuantity()", "convertsToQuantity() returns empty for empty collection")
        .testError(
            "boolArray.convertsToQuantity()",
            "convertsToQuantity() errors on array of convertible type (Boolean)")
        .testError(
            "intArray.convertsToQuantity()",
            "convertsToQuantity() errors on array of convertible type (Integer)")
        .testError(
            "stringArray.convertsToQuantity()",
            "convertsToQuantity() errors on array of convertible type (String)")
        .testError(
            "dateArray.convertsToQuantity()",
  ...
  public Stream<DynamicTest> testConvertsToQuantityWithUnit() {
    return builder()
        ...
        .testFalse(
            "'1 \\'kg\\''.convertsToQuantity('invalid_unit')",
        ...
        .group(
            "convertsToQuantity(unitCode) - Calendar duration sources → calendar-to-calendar"
                + " conversions")
        .testTrue(
        ...
        .group(
            "convertsToQuantity(unitCode) - Calendar duration sources → calendar-to-UCUM"
                + " conversions")
        .testTrue(
            "'2 minutes'.convertsToQuantity('s')",
            "convertsToQuantity() returns true for calendar minutes to UCUM 's'")
        .testTrue(
            "'1500 milliseconds'.convertsToQuantity('ms')",
        ...
        .testFalse(
            "'1 week'.convertsToQuantity('months')",
        ...
        .group(
            "convertsToQuantity(unitCode) - Numeric string sources → different unitCode"
                + " (incompatible)")
        .testFalse(
            "'42'.convertsToQuantity('mg')",

...
class ProjectionClauseTest {
  ...
  void testToExpressionTree() {
    ...
    final GroupingSelection selection =
        new GroupingSelection(
            List.of(
                new UnnestingSelection(
                    new Traversal("path1"), new GroupingSelection(List.of()), false),
                new UnnestingSelection(
                    new Traversal("path2"), new GroupingSelection(List.of()), true),
                new RepeatSelection(
                    List.of(new Traversal("path3"), new Traversal("path4")),
                    new GroupingSelection(List.of()),
                    10),
                new UnionSelection(

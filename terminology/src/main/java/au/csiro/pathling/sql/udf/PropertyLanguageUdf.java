...
public class PropertyLanguageUdf implements SqlFunction,
  ...
  private PropertyLanguageUdf(@Nonnull final TerminologyServiceFactory terminologyServiceFactory,
      @Nonnull final FHIRDefinedType propertyType) {
    if (!ALLOWED_FHIR_TYPES.contains(propertyType)) {
      throw new IllegalArgumentException("PropertyLanguageUDF does not support type: " + propertyType);
    }
  ...
  protected Object[] doCall(@Nullable final Coding coding, @Nullable final String propertyCode, @Nullable final String language) {
    ...
    return result.stream()
        ...
        .map(PropertyLanguageUdf::toObjectValue)
        .toArray(Object[]::new);
  }
   ...
   */
  @Nonnull
  public static PropertyLanguageUdf forType(
      @Nonnull final TerminologyServiceFactory terminologyServiceFactory,
      @Nonnull final FHIRDefinedType propertyType) {
    return new PropertyLanguageUdf(terminologyServiceFactory, propertyType);
  }
   ...
   */
  @Nonnull
  public static PropertyLanguageUdf forClass(
      @Nonnull final TerminologyServiceFactory terminologyServiceFactory,
   ...
   */
  @Nonnull
  public static List<PropertyLanguageUdf> createAll(
      @Nonnull final TerminologyServiceFactory terminologyServiceFactory) {

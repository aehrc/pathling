...
public class DisplayLanguageUdfTest extends AbstractTerminologyTestBase {
  ...
  private DisplayLanguageUdf displayUdf;
  ...
  void setUp() {
    ...
    displayUdf = new DisplayLanguageUdf(terminologyServiceFactory);
  }
  ...
  void testGetsDisplayName() {
    TerminologyServiceHelpers.setupLookup(terminologyService)
        .withDisplayLanguage(CODING_A, DISPLAY_NAME_A, null)
        .withDisplayLanguage(CODING_BB_VERSION1, DISPLAY_NAME_B, null);

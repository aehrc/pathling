...
class CachingTerminologyServiceTest {
  ...
  static final Coding DIABETES_CODING = new Coding(SNOMED_URI, "73211009", "Diabetes mellitus");
  static final Coding INACTIVE_CHLOROQUINE_POISONING_CODING =
      new Coding(SNOMED_URI, "291446002", null);
  ...
  Stream<TestParameters> parameters() {
    return Stream.of(
        ...
        new TestParameters(
            "validate-code",
            () -> terminologyService.validateCode(ALL_CODES_VALUE_SET_URL, T2D_CODING),
            true,
            false,
            false),
        ...
        new TestParameters(
            ...
            () ->
                terminologyService.translate(
                    INACTIVE_CHLOROQUINE_POISONING_CODING, SAME_AS_CONCEPT_MAP_URL, false, null),
        ...
        new TestParameters(
            "subsumes",
            () -> terminologyService.subsumes(T2D_CODING, DIABETES_CODING),
            SUBSUMEDBY,
            false,
            false),
        ...
        new TestParameters(
            ...
            List.of(Property.of("inactive", new BooleanType(true))),
            false,
            false),
        ...
        new TestParameters(
            ...
            () ->
                terminologyService.validateCode(
                    NON_EXISTENT_VALUE_SET, CHLOROQUINE_POISONING_CODING),
            false,
            true,
            false),
        ...
        new TestParameters(
            "invalid subsumes",
            () -> terminologyService.subsumes(LOINC_CODING, DIABETES_CODING),
            NOTSUBSUMED,
            false,
            true));
  }
        ...
        new WireMockServer(
            new WireMockConfiguration()
                ...
                .usingFilesUnderDirectory(
                    "src/test/resources/wiremock/CachingTerminologyServiceTest"));
  ...
  void tearDown() {
    if (isRecordMode()) {
      ...
      final RecordSpecBuilder specBuilder =

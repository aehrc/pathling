...
public class LoincMetadataWriter {
  ...
  public LoincMetadataWriter(FhirContext fhirContext, SessionFactory sessionFactory, String url,
      String version) {
  ...
  private void createDimensionAttribute(String name, String title, String typeCode) {
    ...
    dimensionAttributeReference
        .setReference("DimensionAttribute/" + dimensionAttribute.getIdElement().getIdPart());

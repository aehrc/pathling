 ...
 */
@Disabled(
    "The large-scale synthetic round trip is deferred by decision 68 (T077). Re-enable this class"
        + " to reinstate it.")
class SyntheaRoundTripTest {
  ...
  void roundTripsTheCorpus(@Nonnull final String resourceType) {
    ...
    assertEquals(
        0,
        harness.assertRoundTrip(resourceType, corpus).getPrimitiveMetadata(),

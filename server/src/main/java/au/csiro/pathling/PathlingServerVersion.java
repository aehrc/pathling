...
/**
 * Retrieves version information for the Pathling server from the properties file created during the
 * build, making it available to other areas of the application.
 *
 * @author John Grimes
 */
@Slf4j
public final class PathlingServerVersion {

  private static final String GIT_PROPERTIES_FILE_NAME = "pathling-server-version.properties";

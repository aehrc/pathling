...
public class FhirServerTestConfiguration {
    ...
    public QueryableDataSource deltaLake(PathlingContext pathlingContext) {
        return new DataSourceBuilder(pathlingContext).delta(Path.of("src/test/resources/test-data/fhir/delta").toAbsolutePath().toString());
    }
    ...
    static SparkSession sparkSession(
        ...
        final SparkSession spark = SparkSession.builder()
                ...
                .config("spark.sql.warehouse.dir", "file://" + Path.of("src/test/resources/test-data/fhir/out").toAbsolutePath().toString())
                .getOrCreate();

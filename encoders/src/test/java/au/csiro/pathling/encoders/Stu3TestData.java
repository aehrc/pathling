...
import org.hl7.fhir.dstu3.model.Condition.ConditionVerificationStatusEnumFactory;
...
public class Stu3TestData {
  ...
  public static Condition newCondition() {
    ...
    final ConditionVerificationStatus verificationStatus = new ConditionVerificationStatusEnumFactory().fromCode(
        "confirmed");
  ...
  public static Device newDevice() {
    ...
    final DeviceUdiComponent udi = new DeviceUdiComponent();
    udi.setDeviceIdentifier("1234567890");
    device.setUdi(udi);
  ...
  public static Questionnaire newQuestionnaire() {
    ...
    final Type initial = new DecimalType(TEST_VERY_BIG_DECIMAL);
    ...
    final Type nestedInitial = new DecimalType(TEST_SMALL_DECIMAL);
    nestedItem.setInitial(nestedInitial);
  ...
  public static Condition newConditionWithExtensions() {
    ...
    final ConditionStageComponent stage = new ConditionStageComponent();
    stage.setExtension(
        Collections.singletonList(new Extension("uuid:ext12", new StringType("ext12")))
    );
    conditionWithExtension.setStage(stage);

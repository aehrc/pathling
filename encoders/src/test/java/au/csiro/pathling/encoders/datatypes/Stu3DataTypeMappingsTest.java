...
import au.csiro.pathling.encoders.datatypes.stu3.Stu3DataTypeMappings;
...
public class Stu3DataTypeMappingsTest {
  ...
  private final static List<String> ALLOWED_STU3_OPEN_ELEMENT_TYPES = Arrays.asList(
      "base64Binary",
      "boolean",
      "code",
      "date",
  ...
  private final DataTypeMappings dataTypeMappings = new Stu3DataTypeMappings();
  ...
  public void testCorrectChoicesOnOpenElementType() {
    ...
    final Set<String> expectedOpenElementTypes = ALLOWED_STU3_OPEN_ELEMENT_TYPES.stream()

...
public class PathlingContextTest {
    ...
    public void testEncodeResourcesFromJson() {
        ...
        final Dataset<Row> patientsDataframe = pathling.encode(jsonResources.toDF(), "Patient", FhirMimeTypes.FHIR_JSON);
    ...
    public void testEncoderOptions() {
        ...
        // Test the defaults
        final Row defaultRow = PathlingContext.of(spark).encode(jsonResourcesDF, "Questionnaire").head();

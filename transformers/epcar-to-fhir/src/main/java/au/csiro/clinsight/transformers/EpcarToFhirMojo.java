...
public class EpcarToFhirMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            try {
                ...
                logger.info(
                        "Wrote transactions to " + outputPath + " in " + String.format("%.1f", elapsedSecs) + " ms");
            } finally {
                fileWriter.close();
            }
        } catch (Exception e) {
    ...
    private void transformFiles(EpcarToFhirTransformer transformer, FileWriter fileWriter, File[] files)
            throws Exception {

...
public class EpcarToFhirTransformerTest {
  ...
  public void setUp() throws Exception {
    ...
    fhirBundleStream = getClass()
        .getResourceAsStream("/fhir/1.1631610836532992.29761628.Bundle.json");
    ...
    List<Parameters.ParametersParameterComponent> matchParts1 = Arrays
        .asList(equivalence1, concept1);
    ...
    List<Parameters.ParametersParameterComponent> matchParts2 = Arrays
        .asList(equivalence2, concept2);

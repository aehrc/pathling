...
public class DimensionAttributePersistenceTest {
    ...
    public void setUp() {
        ...
        dimensionAttribute.setType(new Coding("http://hl7.org/au.csiro.clinsight.fhir/ValueSet/defined-types",
                                              "string",
                                              "string"));
    ...
    public void testFindDimensionAttributeById() {
        DimensionAttribute result = entityManager.find(DimensionAttribute.class, "my-dimension-attribute");
    ...
    public void testFindAllDimensionAttributes() {
        TypedQuery<DimensionAttribute> query = entityManager.createQuery("SELECT da FROM DimensionAttribute da",

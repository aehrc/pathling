...
/**
 * Utility class for generating unique dimension and fact table names from Dimension and Metric resources.
 *
 * @author John Grimes
 */
public abstract class Naming {
    ...
    public static String tableNameForMultiValuedDimension(FactSet factSet, String attributeName, Dimension dimension) {
        String tableName = "bridge_" + tableNameForFactSet(factSet) + "_" + attributeName + "_" + tableNameForDimension(
                dimension);

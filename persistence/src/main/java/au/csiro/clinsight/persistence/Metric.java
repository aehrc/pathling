...
/**
 * Describes a statistical measure over a set of facts. Metrics can be used in conjunction with DimensionAttributes
 * and Filters to request aggregate statistics about data held within a FHIR analytics server.
 *
 * @author John Grimes
 */
@Entity
...
@Table(uniqueConstraints = @UniqueConstraint(name = "factSet_name_uniq", columnNames = {"factSet_key", "name"}))
public class Metric extends DomainResource {
    ...
    protected void listChildren(List<Property> children) {
        ...
        children.add(new Property("title", "string", "The machine-friendly name of the Metric.", 1, 1, title));

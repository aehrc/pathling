...
/**
 * Describes a data field which is available for grouping and filtering within a FHIR analytics server.
 *
 * @author John Grimes
 */
@Entity
...
public class DimensionAttribute extends DomainResource {
    ...
    protected void listChildren(List<Property> children) {
        ...
        children.add(new Property("name", "string", "The display name of the DimensionAttribute.", 1, 1, name));

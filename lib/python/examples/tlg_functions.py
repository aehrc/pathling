...
def main():
    ...
    SINUS_INFECTION_VS="http://snomed.info/sct?fhir_vs=ecl/%3C%3C%2064572001%20%3A%20(%3C%3C%20370135005%20%3D%20%3C%3C%20441862004%20%2C%20%3C%3C%20363698007%20%3D%20%3C%3C%202095001%20)"

    pathling_ctx = PathlingContext(spark,
                                   serverUrl='https://tx.ontoserver.csiro.au/fhir')


    memberOf_df = pathling_ctx.memberOf(coding_df, col('coding'), SINUS_INFECTION_VS, 'is_sinus_infection')

...
class FhirView(QueryWithFilters):
    """
    Represents a FHIR view that describes a way of flattening the data from a specified resource
    type into a tabular format.

    :param subject_resource: A string representing the type of FHIR resource to base the view on.
    :param columns: A sequence of FHIRPath expressions that define the columns to include in the
           view.
    :param variables: A sequence of FHIRPath expressions that define the variables that can be used
           in the view.
    :param filters: An optional sequence of FHIRPath expressions that can be evaluated against each
            resource in the data set to determine whether it is included within the result. The
            expression must evaluate to a Boolean value. Multiple filters are combined using AND
            logic.
    :param data_source: An optional DataSource instance to use for executing the query.
    """
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the FhirView class.

        :param subject_resource: A string representing the type of FHIR resource to base the view
                on.
        :param columns: A sequence of FHIRPath expressions that define the columns to include in
                the view.
        :param variables: A sequence of FHIRPath expressions that define the variables that can be
                used in the view.
        :param filters: An optional sequence of FHIRPath expressions that can be evaluated against
                each resource in the data set to determine whether it is included within the
                result. The expression must evaluate to a Boolean value. Multiple filters are
    ...
    def columns(self) -> Sequence[Expression]:
        """
        Gets the columns to include in the view.

        :return: A sequence of Expression objects representing the columns to include in the view.
        """
        return self._columns
    ...
    def variables(self) -> Sequence[Expression]:
        ...
        :return: A sequence of Expression objects representing the variables that can be used in
                 the view.
        """
    ...
    def _create_jquery(self, data_source: DataSource) -> JavaObject:
        """
        Creates a new instance of a Java-based view object.

        :param data_source: The DataSource instance to use for executing the query.
        :return: A new instance of a Java-based view object.
        """
